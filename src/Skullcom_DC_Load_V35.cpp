...
byte(address) = 0x68;                       //0x68 is the default address for the MCP3426 device
...
void fanControl (void) {
  ...
  if (temp <=35) {                                        // if temp below 35, then turn off, otherwise leave it on...hysterisis
